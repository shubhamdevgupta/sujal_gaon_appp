...
class DwsmLandingScreen extends StatefulWidget {
  const DwsmLandingScreen({super.key});

  @override
  State<DwsmLandingScreen> createState() => _DwsmLandingScreenState();
}

class _DwsmLandingScreenState extends State<DwsmLandingScreen> {
          ...
          Row(
            children: [
              _locationItemWithIcon(
                ...
                title: "State",
                value:
                    "${storageService.getString(AppConstants.prefStateName)}",
              ),
              ...
              _locationItemWithIcon(
                ...
                title: "District",
                value:
                    "${storageService.getString(AppConstants.prefDistrictName)}",
              ),
            ],
          ),
          ...
          Row(
            children: [
              _locationItemWithIcon(
                ...
                title: "Block",
                value:
                    "${storageService.getString(AppConstants.prefBlockName)}",
              ),
