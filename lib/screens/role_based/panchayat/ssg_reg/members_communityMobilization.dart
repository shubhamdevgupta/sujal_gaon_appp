...
class MembersCommunitymobilization extends StatefulWidget {
  ...
  @override
  State<MembersCommunitymobilization> createState() =>
      _MembersCommunitymobilization();
}

class _MembersCommunitymobilization
    extends State<MembersCommunitymobilization> {
            ...
            children: [
              _sectionCard(
                ...
                children: [
                  ...
                  _input("Complete Address", maxLines: 3, maxLength: 500),
                  ...
                  if (selectedProgramme == "Any Similar Cadre")
                    _input("Specify Cadre", controller: cadreController),
