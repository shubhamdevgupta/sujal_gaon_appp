...
class NjmLandingpage extends StatefulWidget {
  const NjmLandingpage({super.key});

  @override
  State<NjmLandingpage> createState() => _NjmLandingpage();
}

class _NjmLandingpage extends State<NjmLandingpage> {
  @override
