...
class WsoRegularEntry extends StatefulWidget {
  const WsoRegularEntry({super.key});

  @override
  State<WsoRegularEntry> createState() => _WsoRegularEntry();
}

class _WsoRegularEntry extends State<WsoRegularEntry> {
